              ...
              <div style="flex:1;min-width:0">
                ...
                <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-top:4px">
                  <div style="display:flex;flex-direction:column;gap:4px">
                    ...
                    <button onclick="cfQty('${item.key}',${item.quantity-1})" style="all:unset;width:28px;height:26px;min-width:28px;max-width:28px;min-height:26px;max-height:26px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:inherit;padding:0;margin:0;box-sizing:border-box;-webkit-appearance:none;appearance:none">${SVG_ICONS.minus}</button>
<span style="font-size:13px;width:28px;min-width:28px;text-align:center;height:26px;line-height:26px;border-left:1px solid rgba(0,0,0,0.25);border-right:1px solid rgba(0,0,0,0.25)">${item.quantity}</span>
<button onclick="cfQty('${item.key}',${item.quantity+1})" style="all:unset;width:28px;height:26px;min-width:28px;max-width:28px;min-height:26px;max-height:26px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:inherit;padding:0;margin:0;box-sizing:border-box;-webkit-appearance:none;appearance:none">${SVG_ICONS.plus}</button>
                    </div>
                  </div>
