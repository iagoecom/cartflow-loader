...
if (!nextT) {
  ...
  rawText = `Add ${rem} more to unlock ${nextT.reward_description||'the next reward'}`;
        ...
        sorted.forEach((tier, idx) => {
          ...
          barHtml += `<div style="flex:1 !important;border-radius:9999px !important;overflow:hidden !important;height:${v.rewards_bar_height||8}px !important;background:${v.rewards_bar_bg_color||'#efefef'} !important;padding:0 !important;margin:0 !important"><div style="height:100%;border-radius:9999px;background:${v.rewards_bar_fg_color||'#303030'};transition:width 0.4s;width:${lp}%"></div></div>`;
